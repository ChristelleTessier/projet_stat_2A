---
title: "Répartition des données data 2005-2014"
format:
  pdf:
    toc: true
    toc-depth: 4
...
data <- read_excel("../donnees/data_2005_2014.xlsx", sheet = 1, guess_max = 100000)
```

\newpage
# Répartition générale par campagne
* Filtre sur campagne (2008-2009, 2009-2010 et 2013-2014)
